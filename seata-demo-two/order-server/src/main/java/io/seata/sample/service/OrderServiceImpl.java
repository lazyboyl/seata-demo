...
public class OrderServiceImpl implements OrderService{
     ...
     */
    @Override
    @GlobalTransactional(name = "fsp-create-order-time-out",rollbackFor = Exception.class)
    public void createTimeOut(Order order) {
        LOGGER.info("------->交易开始");
        //本地方法
        ...
        accountApi.decreaseTimeOut(order.getUserId(),order.getMoney());
